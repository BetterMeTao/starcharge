            ...
            <!--<div v-for="(item, index) in items" :key="index">-->
                <!--<div class="full-page-img-wrapper" :style="getStyle(index)">-->
                    <!--<div v-if="index === items.length -1" class="button-wrapper" @click="handleClick()">-->
                        <!--<span class="button">3333333333</span>-->
                    <!--</div>-->
                    <!--<slide class="sub-slide" v-if="index===0"-->
                           <!--:loop="true">-->
                        <!--<div v-for="(slideItem,slideindex) in slideData" :key="slideindex">-->
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        data () {
            return {
                items: [
                  require('../../../assets/img/spring.jpeg'),
                  require('../../../assets/img/summer.jpeg'),
                  require('../../../assets/img/fall.jpeg'),
                  require('../../../assets/img/winter.jpeg')
                ],
                slideData: items
            }
        },
        ...
        mounted () {
            this.$root.eventBus.$on('changePage', (index) => {
